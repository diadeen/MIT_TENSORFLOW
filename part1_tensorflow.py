...
Original file is located at
    https://colab.research.google.com/github/aamini/introtodeeplearning/blob/master/lab1/Part1_TensorFlow.ipynb
...
matrix = tf.constant([[1.22,2.22],[4.55,0.55]],tf.float64)
